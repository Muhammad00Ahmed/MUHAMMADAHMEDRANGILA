...
export async function generateStaticParams() {
  // Include drafts so a direct URL still resolves (marked noindex), while
  // getAllPosts() keeps drafts out of the index, sitemap and RSS.
...
export async function generateMetadata({
  ...
  return {
    ...
    // Draft/archived posts stay out of search indexes.
    ...(!isPublished(post) && {
