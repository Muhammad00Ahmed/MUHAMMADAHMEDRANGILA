...
export const metadata: Metadata = {
  title: "Products",
  description:
    "Software products built by Muhammad Ahmed Rangila, including ShopFlow — a full-stack shop management system.",
  alternates: {
    canonical: "/products",
  },
};
    ...
    <div className="py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-16 rounded-xl border bg-muted/30 p-8 text-center">
          <h3 className="mb-2 text-xl font-semibold">More on the way</h3>
          <p className="text-muted-foreground">
            I&rsquo;m actively building AI and automation products. New releases
            will be published here as they ship.
          </p>
        </div>
      </div>
    </div>
