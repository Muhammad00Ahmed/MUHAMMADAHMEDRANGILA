...
export type PostMetadata = {
  /**
   * Publication status. Defaults to "published" when omitted.
   *  - "published": listed on the blog index, included in the sitemap/RSS,
   *    and indexable.
   *  - "draft": hidden from the index, sitemap, RSS, and homepage; the page
   *    is still reachable by direct URL but is marked noindex.
   *  - "archived": same visibility as draft but semantically retired.
   */
  status?: PostStatus;
  title: string;
  description: string;
