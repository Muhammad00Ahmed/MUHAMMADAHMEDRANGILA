        ...
        <div className="relative overflow-hidden rounded-2xl border bg-linear-to-br from-primary/10 via-primary/5 to-background p-12 md:p-16">
          <div className="relative z-10 text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
              ShopFlow is an independent full-stack project built end to end on
              the PERN stack. Get in touch to discuss custom shop management or
              business software for your team.
            </p>
